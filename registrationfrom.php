...
if (isset($_POST['Done'])) {
	...
	$register = mysql_query("INSERT INTO user(name,email,website,comment,age,choose,gender,birthday) VALUES('$name','$email','$website','$comment','$age','$choose','$gender','$birthday')");
}
?>
<!DOCTYPE html>
<html>
